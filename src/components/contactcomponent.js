...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        if(this.state.touched.firstname && firstname.length < 3)
            errors.firstname = 'First Name shuld be >= 3 characters';
        else if(this.state.touched.firstname && firstname.length > 10)
            errors.firstname = 'First Name should be <= 10 characters';

        if(this.state.touched.lastname && lastname.length < 3)
            errors.lastname = 'Last Name shuld be >= 3 characters';
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="text" id="firstname" name="firstname" placeholder="First Name" 
                                        ...
                                        valid={errors.firstname === ''} invalid={errors.firstname !== ''}></Input>
                                    <FormFeedback>
                                        {errors.firstname}
                                    </FormFeedback>
                                </Col>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="text" id="lastname" name="lastname" placeholder="Last Name"    
                                        ...
                                        valid={errors.lastname === ''} invalid={errors.lastname !== ''}></Input>
                                    <FormFeedback>
                                        {errors.lastname}
                                    </FormFeedback>
                                </Col>
                            ...
                            <FormGroup row>
                                ...
                                <Col md ={10}>
                                    <Input type="tel" id="telnum" name="telnum" placeholder="Tel. Number" 
                                        ...
                                        valid={errors.telnum === ''} invalid={errors.telnum !== ''}></Input>
                                    <FormFeedback>
                                        {errors.telnum}
                                    </FormFeedback>
                                </Col>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="email" id="email" name="email" placeholder="Email" 
                                        ...
                                        valid={errors.email === ''} invalid={errors.email !== ''}></Input>
                                    <FormFeedback>
                                        {errors.email}
                                    </FormFeedback>
                                </Col>
